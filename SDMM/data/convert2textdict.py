...
def saveEmbedding(word_dict,model,save_addr,embedding_size=50):
    ...
    cPickle.dump(emb,open(save_addr + 'emb.pkl','w'))
    #return emb
...
if __name__ == "__main__":
    ...
    data_addr = '/home/zhengyk/MatchZoo_zyk/runtime_data/fulltext/cm_train/'
    save_addr = './data/'
    ...
    vector_addr = '~/qcl/reader-qcl/data/data/wiki.zh.text.vector'
